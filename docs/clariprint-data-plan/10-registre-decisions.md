...
| DEC-005 | Clariprint Data possède les profils et politiques, applique les ajustements et génère le JSON ajusté | Acceptée | Product Owner | J0 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
...
| DEC-025 | Marge et prix de vente dans un module distinct de Clariprint Data | Remplacée | Product Owner | J0 | Remplacée par [DEC-005](#décisions-métier-et-produit) |
...
| DEC-029 | Un pool peut déclarer ses montants comme coûts de production ou tarifs commerciaux | Acceptée | Product Owner | J0 | [PRD 0.6](../../prd/clariprint-data-prd.md) |
| DEC-030 | Une politique profil peut être globale ou spécifique par machine et possède une période de validité | Acceptée | Product Owner | J0 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
| DEC-031 | Un profil accepte plusieurs clés locales ou peut être publié pour un mode d'accès externe | Acceptée | Product Owner | J7 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
| DEC-032 | Formules exactes de marge sur coût, majoration et remise | Ouverte | À nommer | J0 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
| DEC-033 | Remplacement ou cumul entre politique globale et exception machine | Ouverte | À nommer | J0 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
| DEC-034 | Protocole de résolution externe des profils publiés | Ouverte | À nommer | J7 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
...
| ARCH-014 | Le solveur d'optimisation reste extérieur ; Clariprint Data applique les politiques tarifaires avant l'appel | Acceptée | Product Owner | J0 | [Analyse PRD initial](./13-analyse-prd-initial-printflow.md) |
| ARCH-015 | Clariprint Data génère un JSON complet ajusté et déterministe pour le solveur | Acceptée | Product Owner | J7 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
...
| ARCH-017 | Le solveur ne réapplique pas les politiques du profil au dataset ajusté | Acceptée | Product Owner | J7 | [Contrats d'accès calcul](../architecture/specifications/modules/clariprint-data/capabilities/calculation-access-contracts.md) |
