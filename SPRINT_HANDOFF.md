...
- `main` est tenu **fast-forward synchronise** avec cette branche apres CHAQUE story approuvee et deployee (jamais de merge --no-ff, jamais de commit sur `main` directement). Dernier commit commun aux deux : `95f223a7 fix(v5): E10.18a - extension .ts explicite sur l import du fuseau`.
...
**Prochain lot : E10.18b** (les deux vues SQL du jeu de donnees, verifiables en SQL sans produire aucun fichier).
