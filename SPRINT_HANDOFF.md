...
- **qa REJETÉE** (politique pure juste et testée). Points bloquants :
  ...
  **2026-09-16, décisions d'Arnaud appliquées** :
  ...
  - **Q3 (dorure, soft-touch)** : recommandation posée à Arnaud = masquer ces deux finitions tant que leurs codes ne sont pas obtenus, pour ne pas bloquer le lot du configurateur. En attente de sa validation.
