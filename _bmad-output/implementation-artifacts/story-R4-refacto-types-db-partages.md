...
|---|---|---|---|---|---|---|
| [TF-70](https://app.notion.com/35ed0131973c81a4b37ac35eba0bc8e6) | R4 — Types DB partagés database.types.ts + 4 schemas zod sélectifs | OK | P1 — Importante | P00 — Création espace tenant | B5 | R4 |
