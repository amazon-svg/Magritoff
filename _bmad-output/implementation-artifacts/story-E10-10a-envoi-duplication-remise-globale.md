...
> Ce story document est un **lot** de la story Notion **E10.10** : le périmètre ci-dessous est celui de la story entière ; la part propre à ce lot est décrite dans la partie implémentation.
