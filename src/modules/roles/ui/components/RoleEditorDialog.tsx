...
} from '@/modules/roles/ui/hooks/roleManagement.types';
import {
  Dialog,
  DialogClose,
  DialogContent,
...
export type { NotifyPolicy, RoleScope, TenantRoleDefinition } from '@/modules/roles/ui/hooks/roleManagement.types';
...
export interface RoleEditorDialogProps {
  ...
  role?: TenantRoleDefinition | undefined;
  ...
  defaultNameForCreate?: string | undefined;
