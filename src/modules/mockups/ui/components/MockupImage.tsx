...
import { ProductMockup } from "@/modules/mockups/ui/components/ProductMockup";
import {
  type MockupSpecs,
...
export function MockupImage(props: MockupImageProps): ReactElement {
  const { mockups } = useWorkspaceUiRuntime();
