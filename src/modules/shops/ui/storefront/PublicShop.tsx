...
import { PortalProduct } from '@/modules/catalog/ui/storefront';
...
import { GammePage } from '@/modules/catalog/ui/gamme';
import { ResumeBanner, buildResumeChips } from '@/modules/orders/ui/storefront';
import { ShopForbidden403 } from '@/modules/shops/ui/storefront/ShopForbidden403';
import { resolveShopAccess } from '@/modules/shops/ui/storefront/ShopAccessGuard.helpers';
import { filterProductsByExpandedGammes, groupProductsByGamme, loadExpandedGammes, saveExpandedGammes } from '@/modules/catalog/ui/storefront';
import { buildShopTaxonomy } from '@/modules/catalog/ui/helpers';
import { parsePortalPath, shopUrl } from '@/surfaces/customer-portal/portal-routes';
import { StorefrontDelegationBanner } from '@/modules/shop-customers/ui/storefront';
import { StorefrontUnavailable } from '@/modules/shops/ui/storefront/StorefrontUnavailable';
