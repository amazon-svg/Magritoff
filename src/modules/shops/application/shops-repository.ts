...
import type { CreateShopCommand, CreateShopProductCommand, ShopDto, ShopProductDto, UpdateShopCommand, UpdateShopProductCommand } from '../api/contracts.ts';

export class ShopRejectedError extends Error {
  constructor(public readonly code: 'permission_denied' | 'shop_not_found' | 'product_not_found' | 'conflict' | 'invalid_request', message: string) {
