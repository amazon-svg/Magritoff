...
import { validateProEmail } from '@/modules/tenants/ui/helpers/emailValidator';
import { validateSiren, SirenInfo } from '@/modules/tenants/ui/helpers/sirenValidator';
import { REQUIRE_PRO_EMAIL, REQUIRE_VERIFIED_SIREN } from '@/shared/config/featureFlags';
...
export function TenantOnboarding() {
  ...
  const submit = async (e?: FormEvent, opts: { skipGammes?: boolean } = {}) => {
    ...
    const tenantId = await createTenant({
      slug: slug.trim(),
      name: name.trim(),
      ...(sirenInfo ? { siren: sirenInfo.siren, sirenData: sirenInfo } : {}),
