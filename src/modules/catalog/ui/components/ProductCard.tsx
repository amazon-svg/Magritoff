...
import { enrichProduct, resolveProductGamme } from "@/modules/catalog/ui/helpers/productEnrichment";
import { ProductMockup } from '@/modules/mockups/ui/components';
import { MockupImage } from '@/modules/mockups/ui/components';
import {
...
import { getTaxRate } from '@/modules/orders/ui/helpers';
import { useClariprintProduct } from '@/modules/clariprint/ui/hooks';
import { ProductCard3D } from "@/modules/catalog/ui/product-card/ProductCard3D";
import { ProductCardDebug } from "@/modules/catalog/ui/product-card/ProductCardDebug";
import { ProductCardEditer } from "@/modules/catalog/ui/product-card/ProductCardEditer";
import { ProductCardFiche } from "@/modules/catalog/ui/product-card/ProductCardFiche";
import { ProductCardPrix } from "@/modules/catalog/ui/product-card/ProductCardPrix";
import { extractClariprintConfigFromAtelierProduct } from "@/modules/catalog/ui/storefront/ProductOverlay.helpers";
...
export function ProductCard({
  ...
  const { clariprint } = useWorkspaceUiRuntime();
                ...
                if (imgError || !src) {
                  ...
                  return (
                    <MockupImage
                      tenantId="atelier"
                      shopId="atelier"
                      productId={localProduct.id ?? localProduct.name}
                      width={dims.width}
                      height={dims.height}
