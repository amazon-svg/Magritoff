...
import { resolveTemplate } from "@/modules/catalog/ui/helpers/productEnrichment";
import { resolveMockupTemplate, type MockupTemplate, type MockupTemplateInput } from '@/modules/mockups/ui/helpers';
