...
import { resolveFamilyIdentity, FAMILY_ICON } from '@/modules/catalog/ui/helpers/productFamilyIdentity';
...
export function resolveShopFamily(
  product: { config?: unknown; name?: string | undefined; category?: string | undefined; kind?: string | undefined; gamme_slug?: string | null | undefined },
  gammes: Gamme[] = [],
): ShopFamily {
  if (gammes.length > 0) {
