...
import type { TaxonomyFamily } from '@/modules/catalog/ui/helpers/shopTaxonomy';
import { categoryEditorialCacheKey, type CategoryEditorial } from '@/modules/catalog/ui/helpers/catalogLanding';
...
export function useStorefrontCategoryEditorial(
  ...
  const api = useStorefrontApi(DiagnosticsApiClient);
