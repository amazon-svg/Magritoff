...
import { usePimAutomation } from '@/modules/catalog/ui/hooks/usePimAutomation';
  ...
  const generate = async () => {
    ...
    try {
      const generated = await pimAutomation.generateDefinition({
        gammeSlug: gamme.slug, gammeName: gamme.name, gammeMatchingRules: gamme.matching_rules as Record<string, unknown>,
