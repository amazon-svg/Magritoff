 ...
 * (aucune I/O) : il prend un TABLEAU de lignes DEJA lues (le plafond
 * `ORDER_EXPORT_ROW_LIMIT`, `order-export-generation-service.ts`, est
 * verifie AVANT cet appel, jamais ici) et rend des octets.
 */
