...
export interface components {
    schemas: {
         ...
         *
         *     « MONTANT HT » EST DEJA NET DE LA REMISE DE LIGNE. La colonne « Taux de remise ligne » est INFORMATIVE : elle dit ce qui a ete consenti, elle ne se soustrait pas une seconde fois. Le montant avant geste commercial est donne a cote (« Montant HT barème (avant remise) ») pour que la remise soit verifiable par difference plutot que par confiance.
         *
