...
import { createShopCommandSchema, createShopProductCommandSchema, mockupTemplateTypeSchema, mockupViewSchema, publicShopCatalogSchema, publicShopProbeSchema, setShopPricingCommandSchema, shopBrandAssetKindSchema, shopBrandAssetResultSchema, shopCustomMockupMutationResultSchema, shopCustomMockupsSchema, shopMutationResultSchema, shopPricingMutationResultSchema, shopPricingOverridesSchema, shopProductSchema, shopProductsSchema, shopRemovalResultSchema, shopSchema, tenantShopsSchema, updateShopCommandSchema, updateShopProductCommandSchema } from '../../modules/shops/api/contracts.ts';
